...
public class MintKeyManagementImpl implements MintKeyManagement {

    private final DeterministicSeed MASTER_SEED;
    private final String ACTIVE_PATH;

    public MintKeyManagementImpl(String masterSeed, String activePath) throws UnreadableWalletException {
    ...
    @Override
    public void lookupKeysetById(String id) {

    }

    @Override
    public void signForAmountById(BigInteger amoumt, String id) {
